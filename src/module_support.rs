            ...
            (
                ...
                wat::parse_str(
                    r#"(module
                        ...
                        (type $path_readlink (func (param i32 i32 i32 i32 i32 i32) (result i32)))
                        ...
                        (import "wasi_snapshot_preview1" "fd_fdstat_set_flags" (func (type $fd_fdstat_set_flags)))
                        (import "wasi_snapshot_preview1" "path_open" (func (type $path_open)))
                        (import "wasi_snapshot_preview1" "path_readlink" (func (type $path_readlink)))
